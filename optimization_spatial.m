% train CRF
function [f df] = optimization_spatial(x)
    ...
    for i=2007:2007
        ...
        load(['/home/lakesh/Aerosol/colloc_data_summer_' num2str(i) '.mat']);
        ...
        for j=1:number_of_days
            ...
            b = 2 * (alpha11 * spdiags(indicator_misr_alone, 0, labelled_size, labelled_size) * forecast_misr + ... 
                alpha21 * spdiags(indicator_modis_alone, 0, labelled_size, labelled_size) * forecast_modis + ...
                alpha12 * spdiags(indicator_misr_modis, 0, labelled_size, labelled_size) * forecast_misr + ...
                alpha22 * spdiags(indicator_misr_modis, 0, labelled_size, labelled_size) * forecast_modis);
    ...
    [alpha11  alpha21 alpha12 alpha22 beta1]
    toc;
